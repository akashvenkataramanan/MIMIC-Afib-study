-- Most-recent Potassium and Magnesium within 24h BEFORE cardioversion
-- Input:  {{PROJECT}}.{{DATASET}}.cv_for_afib
-- Output: {{PROJECT}}.{{DATASET}}.cv_for_afib_labs24
-- Source: physionet-data.mimiciv_3_1_hosp.labevents

-- Tunable lookback window
DECLARE LOOKBACK_HOURS INT64 DEFAULT 24;

CREATE OR REPLACE TABLE `{{PROJECT}}.{{DATASET}}.cv_for_afib_labs24` AS
WITH
cv AS (
  SELECT
